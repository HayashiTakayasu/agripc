      ...
      #start
        ...
        loop do
            ...
            x=multiple_pulse_timer(time_array3,wait_time)              
              ...
              #house1 motor
              dacs_bit.boolbit(bit1,9)
              dacs_bit.boolbit(bit2,10)
              #house2 motor
              dacs_bit.boolbit(bit3,11)
              dacs_bit.boolbit(bit4,12)
              ...
              #command output
               ...
               hex=Bit.new(hex0.to_i(2)).tos(6,16)
                ...
                3.times do |i|
                  ...
                  Loger::loger(log+"/kr_command_log.txt",time+","+command.chomp+","+res.inspect.chomp+,",#{i.to_s}")
